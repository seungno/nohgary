...
#H:\HeroRiseMan\Reference\Background\AncientKingdomINT\GPU\
    ...
    copy_pathB = "D:\DinoPowers_convert\DinoPowers"+"\{0}".format(top_name)+"\source"+"\{0}".format(filename)
...
refine_path = "P:\DinoPowers\Reference\Background"+"\{0}".format(top_name)+"\GPU"
