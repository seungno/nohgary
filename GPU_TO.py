...
def unreal_refine_file (file_name="" ):
    ...
    file_path = "D:\DinoPowers_convert\DinoPowers\{0}\{1}.t3d".format(BG_folder,file_name)
    ...
    write_path = "D:\\DinoPowers_convert\\DinoPowers\\"
...
def actor_divide (file_name = ""):
    ...
    BG_folder =  file_name.split("_")[1]
    my_file_path = "D:\DinoPowers_convert\DinoPowers\{0}\{1}.txt".format(BG_folder,file_name)
    ...
    for key, value in ResultDict.items():
        ...
        for key, value in EtcResultDict.items():
            ...
            if Etc_actor == actor_name and Etc_import == import_name :
                ...
                cmds.setAttr ("{0}.rotate".format(aa[0]),(EtcResultDict[key].get("Rotation")[0]+roX), (EtcResultDict[key].get("Rotation")[1]+roY), (EtcResultDict[key].get("Rotation")[2]+roZ))
